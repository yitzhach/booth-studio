  ...
  document.addEventListener("change", (ev) => {
    ...
    mutate(() => {
      ...
      if (scope === "booth" && key === "envPreset") {
        ...
        if (isArtShow(p) && value !== "studio" && hallSpec(p.booth).on) {
